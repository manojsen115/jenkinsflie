...
//mail bcc: '', body: "this is body ${env.BUILD_URL}", cc: '', from: 'jenkins@gmail.com', replyTo: '', subject: 'FW: Build failed in Jenkins:', to: 'manojsen115@gmail.com' 	
				...
				//start
mail bcc: '', body: "Hi *This was an auto generated mail from Jenkins please do not reply* see <${evn.BUILD_URL}>", cc: '', from: 'jenkins@gmail.com', replyTo: '', subject: 'Build failed in Jenkins: ${evn.JOB_NAME} #${evn.BUILD_NUMBER}', to: 'manojsen115@gmail.com'
