pipeline
{
    	...
    	stages
	{
		...
		//bat  'copy C:\\IIB_Workspace\\SHARED_LIB_BBTG_WMB_ESQL_UTILITIES\\Demo_jenkin1.bar C:\\ARTIFACTORY\\Demo_jenkin1.bar'
				...
				//woriking mail :mail bcc: '', body: "this is body ${env.BUILD_URL}", cc: '', from: 'jenkins@gmail.com', replyTo: '', subject: 'FW: Build failed in Jenkins:', to: 'manojsen115@gmail.com' 	
...
see <${evn.BUILD_URL}>
---------------------------------------------------------------------------------------
Flow Name: JOB_NAME, Build Number : ${evn.BUILD_NUMBER} and Branch Name: ${evn.BRANCH_NAME}
...
Regards,
Jenkins/Broker
", cc: '', from: 'jenkins@gmail.com', replyTo: '', subject: 'Build failed in Jenkins: ${evn.JOB_NAME} #${evn.BUILD_NUMBER}', to: 'manojsen115@gmail.com'
